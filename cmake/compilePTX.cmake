# Create a PTX file from a .cu source and copy it to VIENNACORE_PTX_DIR.
#
# Usage:
#   set(VIENNACORE_PTX_DIR "${CMAKE_BINARY_DIR}/ptx")  # or any path
#   viennacore_add_ptx(my_kernel_ptx "${CMAKE_CURRENT_SOURCE_DIR}/kernel.cu")
#
# Result:
#   - Builds: <binary_dir>/<target_name>.ptx
#   - Copies to: ${VIENNACORE_PTX_DIR}/<target_name>.ptx
...
function(viennacore_add_ptx target_name cu_file)
  ...
  set(ptx_dst "${VIENNACORE_PTX_DIR}/${target_name}.ptx")
