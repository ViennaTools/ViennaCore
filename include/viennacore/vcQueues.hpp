...
public:
  BoundedPQueue(SizeType passedMaximumSize) : maximumSize(passedMaximumSize) {}
...
public:
  ClampedPQueue(K passedThresValue) : thresValue(passedThresValue) {}
