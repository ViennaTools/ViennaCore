...
//   DeviceContextRegistry::getInstance().clear();

//   // Test 1: Create context and register it globally
//   auto context0 = DeviceContext::createContext();
//   VC_TEST_ASSERT(context0 != nullptr);
//   VC_TEST_ASSERT(context0->getDeviceID() == 0);

//   // Test 2: Check if context is in registry
//   VC_TEST_ASSERT(DeviceContext::hasContextInRegistry(0));
//   VC_TEST_ASSERT(!DeviceContext::hasContextInRegistry(1));

//   // Test 3: Retrieve context from registry
//   auto retrievedContext = DeviceContext::getContextFromRegistry(0);
...
//       DeviceContext::createContext(VIENNACORE_KERNELS_PATH, 0, true);
//   VC_TEST_ASSERT(context0_duplicate.get() == context0.get()); // Same
//   instance

//   // Test 6: Create context without registering globally
//   auto localContext =
//       DeviceContext::createContext(VIENNACORE_KERNELS_PATH, 0, false);
...
//   auto nullContext = DeviceContext::getContextFromRegistry(0);
...
//   // Verify cleanup
//   VC_TEST_ASSERT(!DeviceContext::hasContextInRegistry(0));
//   deviceIDs = DeviceContext::getRegisteredDeviceIDs();
...
//   auto &registry = DeviceContextRegistry::getInstance();
